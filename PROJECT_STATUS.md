...
- [ ] Draft Week 4 Literature Assessment (2,000-2,500 words, APA) covering 3+ common themes, 3+ gaps/weaknesses, 3+ research implications, ending in a testable/falsifiable research question — preliminary notes drafted in `week04/assignments/`; still need the final formatted 2,000-2,500 word paper with full APA reference list and word-count check
