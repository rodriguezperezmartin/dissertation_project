...
- [ ] Draft Week 4 Literature Assessment (2,000-2,500 words, APA) covering 3+ common themes, 3+ gaps/weaknesses, 3+ research implications, ending in a testable/falsifiable research question — **final draft complete with all 10 sources cited and references added**; still need to (a) paste the finalized sentence + reference list into the actual Word doc, (b) verify word count is within 2,000-2,500
